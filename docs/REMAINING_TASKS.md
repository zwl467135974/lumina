...
**代码位置**：
- ✅ `lumina-frontend/src/views/system/user.vue` - 用户管理页面（已完成）
- ✅ `lumina-frontend/src/views/system/role.vue` - 角色管理页面（已完成）
- ✅ `lumina-frontend/src/views/system/permission.vue` - 权限管理页面（已完成）
- ✅ `lumina-frontend/src/views/system/tenant.vue` - 租户管理页面（已完成）
- ✅ `lumina-frontend/src/views/agent/form.vue` - Agent创建/编辑页面（已完成）
