...
- [项目搭建执行计划](docs/guides/项目搭建执行计划.md) - 后端项目搭建指南
- [前端搭建执行计划](docs/guides/前端搭建执行计划.md) - 前端项目搭建指南
...
- [Lumina框架说明](docs/brand/lumina框架说明.md) - 框架品牌与定位
- [Fastjson2与Jackson对比分析](docs/rfc/Fastjson2与Jackson对比分析.md) - JSON 库选型分析
